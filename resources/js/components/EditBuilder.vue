    ...
    <div class="Polaris-Page-Header Polaris-Page-Header--hasNavigation Polaris-Page-Header--mediumTitle">
        <div class="Polaris-Page-Header__Row">
          ...
          <div class="Polaris-Page-Header__TitleWrapper">
            <h1 class="Polaris-Header-Title">{{ bundle.bundle_name }}</h1>
          </div>
        </div>
    </div>
                                            ...
                                            <label class="Polaris-Choice" for="PolarisCheckbox137">
                                                <span class="Polaris-Choice__Control">
                                                    <span class="Polaris-Checkbox">
                                                        <input v-model="bundle.add_note_field" id="PolarisCheckbox137" type="checkbox" class="Polaris-Checkbox__Input" aria-invalid="false" aria-describedby="PolarisCheckbox137HelpText" role="checkbox" aria-checked="false" value=""><span class="Polaris-Checkbox__Backdrop"></span>
                                    ...
                                    <div class="Polaris-FormLayout__Item">
                                        <div>
                                            <label class="Polaris-Choice" for="product-description-checkbox">
                                                <span class="Polaris-Choice__Control">
                                                    <span class="Polaris-Checkbox">
                                                        <input v-model="bundle.show_bundle_desc" id="product-description-checkbox" type="checkbox" class="Polaris-Checkbox__Input" aria-invalid="false" aria-describedby="product-description-checkboxHelpText" role="checkbox" aria-checked="false"><span class="Polaris-Checkbox__Backdrop"></span>
                                                        <span class="Polaris-Checkbox__Icon">
                                                            <span class="Polaris-Icon">
                                                                <span class="Polaris-Text--root Polaris-Text--bodySm Polaris-Text--regular Polaris-Text--visuallyHidden"></span>
                                                                <svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true">
                                    ...
                                    <div class="Polaris-FormLayout__Item">
                                        <div>
                                            <label class="Polaris-Choice" for="PolarisCheckbox140">
                                                <span class="Polaris-Choice__Control">
                                                    <span class="Polaris-Checkbox">
                                                        <input v-model="bundle.show_product_desc" id="PolarisCheckbox140" type="checkbox" class="Polaris-Checkbox__Input" aria-invalid="false" aria-describedby="PolarisCheckbox140HelpText" role="checkbox" aria-checked="false" value=""><span class="Polaris-Checkbox__Backdrop"></span>
                                                        <span class="Polaris-Checkbox__Icon">
                                                            <span class="Polaris-Icon">
                                                                <span class="Polaris-Text--root Polaris-Text--bodySm Polaris-Text--regular Polaris-Text--visuallyHidden"></span>
                                                                <svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true">
...
export default {
    ...
    created() {
        axios.get(`/api/bundle/${this.$route.params.id}/edit`).then(response => {
            console.log('+++', response);
            this.bundle = response.data;
        });
        console.log('edit builder', this.bundle);
    },
    methods: {
        next() {
            this.step++;
        ...
        saveBundle() {
            axios.put(`/api/bundle/${this.bundle.id}`, this.bundle).then(response => {
